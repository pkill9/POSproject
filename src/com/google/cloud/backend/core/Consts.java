...
public interface Consts {
     ...
     */
    public static final String PROJECT_ID = "lunar-reef-534";

    /**
     * Set Project Number of your Google APIs Console Project.
     */
    public static final String PROJECT_NUMBER = "569597456645";

    /**
     * Set your Web Client ID for authentication at backend.
     */
    public static final String WEB_CLIENT_ID = "569597456645.apps.googleusercontent.com";
